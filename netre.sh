...
## It can reinstall Debian, Ubuntu, CentOS system with network.2019.3.24ver.
## Suitable for using by GRUB.
## Default root password: SakuraPARK
## Backup By Krystal
## Backup From Vicer
...
[[ -z "$myPASSWORD" ]] && myPASSWORD='$1$0shYGfBd$AV16UH3GAsKmzum9HRa/i1';
[[ -n "$tmpFW" ]] && INCFW="$tmpFW";
[[ -z "$INCFW" ]] && INCFW='0';
